...
void interrupt_loop() {
    // Reboot combo: hold PS + Mute for 2 seconds. Works whether or not the
    // OLED add-on is present. PS+Mute is uncommon during gameplay and the
    // long hold avoids accidental triggers.
    {
